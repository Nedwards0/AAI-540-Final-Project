...
class Proccessor:
    ...
    def convertVideoToImages(self, datafile: DataFile, Generate_Label_Info_As_Json=True, Export_Dir = "Images", split_by_video=True, freq = 30, transform=False, transform_amount = .25, generate_lst=True):
